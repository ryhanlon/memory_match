...
const wordPicture = [['diamond', 'match-one'], ['<i class="fa-diamond"></i>', 'match-one'], ['plane', 'match-two'], ['<i class="fa-paper-plane-o"></i>', 'match-two'], ['anchor', 'match-three'], ['<i class="fa-anchor"></i>', 'match-three'], ['bolt', 'match-four'], ['<i class="fa-bolt"></i>', 'match-four'],['cube', 'match-five'], ['<i class="fa-cube"></i>', 'match-five'], ['leaf', 'match-six'], ['<i class="fa-leaf"></i>', 'match-six'], ['bicycle', 'match-seven'], ['<i class="fa-bicycle"></i>', 'match-seven'], ['bomb', 'match-eight'], ['<i class="fa-bomb"></i>', 'match-eight'] ];

const picturePicture = [['<i class="fa-diamond"></i>', 'match-one'], ['<i class="fa-diamond"></i>', 'match-one'], ['<i class="fa-paper-plane-o"></i>', 'match-two'], ['<i class="fa-paper-plane-o"></i>', 'match-two'], ['<i class="fa-anchor"></i>', 'match-three'], ['<i class="fa-anchor"></i>', 'match-three'], ['<i class="fa-bolt"></i>', 'match-four'], ['<i class="fa-bolt"></i>', 'match-four'],['<i class="fa-cube"></i>', 'match-five'], ['<i class="fa-cube"></i>', 'match-five'], ['<i class="fa-leaf"></i>', 'match-six'], ['<i class="fa-leaf"></i>', 'match-six'], ['<i class="fa-bicycle"></i>', 'match-seven'], ['<i class="fa-bicycle"></i>', 'match-seven'], ['<i class="fa-bomb"></i>', 'match-eight'], ['<i class="fa-bomb"></i>', 'match-eight'] ];
